'''
This code produce an average image from long run frames.
'''
...
out = cv2.VideoWriter('Uca_detection.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 24, (868,464))
...
while vid.isOpened():
    ...
    ### ave
    (B, G, R) = cv2.split(result.astype("float"))
    ...
    if ok:
        ...
        cv2.rectangle(result, p1, p2, (204, 204, 0))
        ...
        # the frame
        cv2.putText(result, direction, (10, 10), cv2.FONT_HERSHEY_SIMPLEX,
                    0.5, (204, 204, 0), 2)
